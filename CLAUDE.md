...
- El sorteo termina al agotarse las 75 balotas, cuando el administrador lo finaliza a mano, o cuando ya se ganaron todas las formas de la partida (no queda ningún premio por repartir).
...
- **Excepción a la pausa: si el bingo que se acaba de detectar gana la ÚLTIMA forma que quedaba en juego, la partida se FINALIZA en vez de pausarse.** Ya no queda ningún premio por repartir, así que un "reanudar" no tendría nada que ofrecer. Una partida sin ninguna forma seleccionada no cuenta como "todo ganado" — es "no hay premios configurados" y no autofinaliza. *(2026-08-12, pedido del cliente.)*
